    ...
    return (
        <div className="flex flex-col justify-center">
            <div className="flex flex-col h-full bg-card shadow justify-between rounded-lg pb-8 p-6 xl:p-8 mt-3 bg-gray-50">
                ...
                <div className="mt-2">
                    <Link className="mt-1 inline-flex gap-2 font-bold items-center border-2 border-transparent outline-none focus:ring-1 focus:ring-offset-2 focus:ring-link active:bg-link active:text-gray-700 active:ring-0 active:ring-offset-0 leading-normal bg-link text-gray-700 hover:bg-opacity-80 text-sm rounded-lg py-1.5"
                        aria-label="Quick Start" target="_blank" rel="noopener noreferrer" href={referenceLink}>
                        <span>Read More</span>
                        <i className="h-4 w-4">
