                ...
                <div className="mx-auto max-w-xl px-6 md:mx-0 md:max-w-none md:py-16 md:px-0">
                    <div>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-6">
                                <Link className="inline-flex rounded-lg bg-indigo-600 px-4 py-1.5 text-white font-semibold leading-7 shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700"
                                    href={link}>
                                    Read More
                                </Link>
                            </div>
