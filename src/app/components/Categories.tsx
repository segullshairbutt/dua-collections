...
export const Category = ({ tag, isActive, onClick, activeClassName = 'text-indigo-600' }: CategoryLinkProps) => {
    return (
        <li className={`text-xs font-medium mx-1 my-1 text-gray-500 active:bg-indigo-100 hover:text-indigo-600 rounded ${isActive ? activeClassName : ''}`}>
